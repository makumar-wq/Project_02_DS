...
step1_load_model.py
====================
Task 4 — Component 1: Load BLIP model with fine-tuned weights.
...
def load_model(weights_dir: str = "outputs/blip/best"):
    ...
    device = get_device()
    print("=" * 62)
    print("  Task 4 — Step 1: Load BLIP Model")
    print("=" * 62)
    ...
    # Keep in float32 — needed for stable hidden-state arithmetic during steering
